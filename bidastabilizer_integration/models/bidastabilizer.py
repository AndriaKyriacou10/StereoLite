...
from bidastabilizer_integration.models.sea_raft_model import SEARAFTModel
...
class BiDAStabilizer(nn.Module):
    def __init__(self, mid_channels=48, num_blocks=5):
        ...
        self.raft = SEARAFTModel() # used in alignment to compute optical flow between frames
